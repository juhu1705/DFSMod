...
public class PlainsStructure extends Structure<NoFeatureConfig> {

    public PlainsStructure(Codec<NoFeatureConfig> p_i51440_1_) {
        super(p_i51440_1_);
    }
    ...
    public static class Start extends MarginedStructureStart {
        ...
        @Override
        public void func_230364_a_(DynamicRegistries p_230364_1_, ChunkGenerator p_230364_2_, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome p_230364_6_, IFeatureConfig p_230364_7_) {
