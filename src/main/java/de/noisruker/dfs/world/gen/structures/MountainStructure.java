...
public class MountainStructure extends Structure<NoFeatureConfig> {
    ...
    public MountainStructure(Codec<NoFeatureConfig> p_i51440_1_) {
        super(p_i51440_1_);
    }
    ...
    public static class Start extends MarginedStructureStart {
        ...
        @Override
        public void func_230364_a_(DynamicRegistries p_230364_1_, ChunkGenerator p_230364_2_, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biome, IFeatureConfig p_230364_7_) {
